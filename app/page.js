  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,#ffffff_0%,#f8fbff_52%,#fff8f1_100%)] text-slate-900">
      ...
      <main className="mx-auto max-w-7xl px-4 py-6 pb-12 sm:px-6 lg:px-8">
        <section className="rounded-[28px] border border-sky-100 bg-[linear-gradient(135deg,#ffffff_0%,#f8fbff_62%,#fff7ed_100%)] p-5 shadow-[0_24px_70px_rgba(15,42,94,0.10)] sm:rounded-[34px] sm:p-8 lg:p-10">
          <div className="grid gap-8 xl:grid-cols-[minmax(0,1.15fr)_minmax(320px,0.85fr)] xl:items-end">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              ...
              <div className="rounded-[24px] border border-sky-100 bg-white px-5 py-5 shadow-[0_18px_45px_rgba(15,42,94,0.06)] sm:col-span-2 sm:rounded-[28px]">
          ...
          <div className="rounded-[26px] border border-sky-100 bg-white p-5 shadow-[0_18px_55px_rgba(15,42,94,0.08)] sm:rounded-[30px] sm:p-8">
            ...
            <div className="mt-8 grid gap-4 md:grid-cols-2">
              {currentFeatures.map((feature) => {
                ...
                return (
                  <div key={feature.title} className="rounded-[22px] border border-sky-100 bg-[linear-gradient(180deg,#ffffff_0%,#f8fbff_100%)] p-5 sm:rounded-[24px]">
        ...
        <section className="mt-8 rounded-[26px] border border-sky-100 bg-white p-5 shadow-[0_18px_55px_rgba(15,42,94,0.08)] sm:rounded-[30px] sm:p-8">
        ...
        <section className="mt-8 rounded-[28px] border border-sky-100 bg-slate-950 px-5 py-8 text-white shadow-[0_24px_60px_rgba(15,23,42,0.24)] sm:rounded-[32px] sm:px-8 sm:py-10">
